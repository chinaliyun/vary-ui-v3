<template>
  <div class="v_alert" :style="style" :class="{ message_open: open, message_close: close }" @click="clickRoot($event)">
    <div class="v_alert_container" :class="{ [type]: type, message_open: open, message_close: close }">
      <div class="v_alert_header">
        ...
        <div class="close_icon" @click="closeAlert()">
          <IconClose />
        </div>
      </div>
